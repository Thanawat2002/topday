...
DP.Dances = {
    ["HT_act_1"] = {"custom@what_idk", "what_idk", "emotes act 1 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_2"] = {"custom@salsa", "salsa", "emotes act 2 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_3"] = {"custom@pickfromground", "pickfromground", "emotes act 3 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_4"] = {"custom@maraschino", "maraschino", "emotes act 4 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_5"] = {"custom@makarena", "makarena", "emotes act 5 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_6"] = {"custom@gangnamstyle", "gangnamstyle", "emotes act 6 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_7"] = {"custom@dig", "dig", "emotes act 7 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_8"] = {"custom@circle_crunch", "circle_crunch", "emotes act 8 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_9"] = {"custom@armwave", "armwave", "emotes act 9 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["HT_act_91"] = {"custom@armswirl", "armswirl", "emotes act 10 ~y~NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
    ["ddance1"] = {"divined@dances@new", "ddance1", "2022 Dance 1 ~r~New~", AnimationOptions =
    {
        EmoteLoop = true
    }},
    ...
    ["T1"] = {"custom@dont_start", "dont_start", "tiktok 1", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T2"] = {"custom@renegade", "renegade", "tiktok 2", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T3"] = {"custom@savage", "savage", "tiktok 3", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T4"] = {"custom@sayso", "sayso", "tiktok 4", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T5"] = {"custom@take_l", "take_l", "tiktok 5", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T6"] = {"custom@rickroll", "rickroll", "tiktok 6", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T7"] = {"custom@orangejustice", "orangejustice", "tiktok 7", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T8"] = {"custom@floss", "floss", "tiktok 8", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["T9"] = {"custom@crossbounce", "crossbounce", "tiktok 9", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},

    ["Tt10"] = {"custom@toosie_slide", "toosie_slide", "tiktok 10", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
    }},
...
DP.Emotes = {
   ...
   ["A10penguin_pose4"] = {"penguin@custom@v1", "penguin_pose4", "Penguin pose 4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A11penguin_pose5"] = {"penguin@custom@v1", "penguin_pose5", "Penguin pose 5 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A12penguin_pose6"] = {"penguin@custom@v1", "penguin_pose6", "Penguin pose 6 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A13penguin_pose7"] = {"penguin@custom@v1", "penguin_pose7", "Penguin pose 7 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["A14penguin_pose8"] = {"penguin@custom@v1", "penguin_pose8", "Penguin pose 8 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["A15penguin_pose9"] = {"penguin@custom@v1", "penguin_pose9", "Penguin pose 9 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A16penguin_pose10"] = {"penguin@custom@v1", "penguin_pose10", "Penguin pose 10 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["A17penguin_dab"] = {"penguin@custom@v1", "penguin_dab", "Penguin dab ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A18penguin_dab1"] = {"penguin@custom@v1", "penguin_dab1", "Penguin dab 1 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["A19penguin_duo1_m"] = {"penguin@custom@v2", "penguin_duo1_m", "Penguin duo m 1 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A20penguin_duo1_f"] = {"penguin@custom@v2", "penguin_duo1_f", "Penguin duo f 1 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A21penguin_duo2_f"] = {"penguin@custom@v2", "penguin_duo2_f", "Penguin duo f 2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A22penguin_duo2_m"] = {"penguin@custom@v2", "penguin_duo2_m", "Penguin duo m 2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A23penguin_pose_couple_m"] = {"penguin@custom@v2", "penguin_pose_couple_m_v2", "Penguin pose couple m ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A24penguin_pose_couple_f"] = {"penguin@custom@v2", "penguin_pose_couple_f_v2", "Penguin pose couple f ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A25penguin_japanom"] = {"penguin@custom@v2", "penguin_japanom", "Penguin japanom ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A26penguin_pose1_v2"] = {"penguin@custom@v2", "penguin_pose1_v2", "Penguin pose 1 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A27penguin_pose2_v2"] = {"penguin@custom@v2", "penguin_pose2_v2", "Penguin pose 2 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A28penguin_pose3_v2"] = {"penguin@custom@v2", "penguin_pose3_v2", "Penguin pose3 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A29penguin_pose4_v2"] = {"penguin@custom@v2", "penguin_pose4_v2", "Penguin pose 4 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A30penguin_pose5_v2"] = {"penguin@custom@v2", "penguin_pose5_v2", "Penguin pose 5 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A31penguin_pose6_v2"] = {"penguin@custom@v2", "penguin_pose6_v2", "Penguin pose 6 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A32penguin_pose7_v2"] = {"penguin@custom@v2", "penguin_pose7_v2", "Penguin pose 7 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A33penguin_pose8_v2"] = {"penguin@custom@v2", "penguin_pose8_v2", "Penguin pose 8 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A34penguin_pose9_v2"] = {"penguin@custom@v2", "penguin_pose9_v2", "Penguin pose 9 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A35penguin_pose10_v2"] = {"penguin@custom@v2", "penguin_pose10_v2", "Penguin pose 10 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A36penguin_pose11_v2"] = {"penguin@custom@v2", "penguin_pose11_v2", "Penguin pose 11 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A37penguin_pose12_v2"] = {"penguin@custom@v2", "penguin_pose12_v2", "Penguin pose 12 v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A38penguin_respect"] = {"penguin@custom@v2", "penguin_respect", "Penguin respect v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["A39penguin_sorry1"] = {"penguin@custom@v2", "penguin_sorry1", "Penguin sorry v2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ---- penguin V3 ----
   ["A40penguin_mppos_pose1"] = {"penguin_mppos@pose_model", "penguin_mppos_pose1", "Penguin pose1 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A41penguin_mppos_pose2"] = {"penguin_mppos@pose_model", "penguin_mppos_pose2", "Penguin pose2 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A42penguin_mppos_pose3"] = {"penguin_mppos@pose_model", "penguin_mppos_pose3", "Penguin pose3 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A43penguin_mppos_pose4"] = {"penguin_mppos@pose_model", "penguin_mppos_pose4", "Penguin pose4 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A44penguin_mppos_pose5"] = {"penguin_mppos@pose_model", "penguin_mppos_pose5", "Penguin pose5 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A45penguin_mppos_pose6"] = {"penguin_mppos@pose_model", "penguin_mppos_pose6", "Penguin pose6 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A46penguin_mppos_pose7"] = {"penguin_mppos@pose_model", "penguin_mppos_pose7", "Penguin pose7 v3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A47penguin_mppos_pose8"] = {"penguin_mppos@pose_model", "penguin_mppos_pose8", "Penguin pose8 v3 ~p~ NEW", AnimationOptions =
   {
   ...
   ["A48penguin_mppos_pose9"] = {"penguin_mppos@pose_model", "penguin_mppos_pose9", "Penguin pose9 v3 ~p~ NEW", AnimationOptions =
   {
       Prop = 'prop_cs_ciggy_01',
       PropBone = 28422,
       PropPlacement = {0.09, 0.02, 0.0, 5.0, 109.0, 10.0},
   ...
   ["A49penguin_mppos_pose10"] = {"penguin_mppos@pose_model", "penguin_mppos_pose10", "Penguin pose10 v3 ~p~ NEW", AnimationOptions =
   {
   ...
   ---- penguin V4 ----
   ["A50penguin_mppos_v4_pose1"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose1", "Penguin_mppos_pose1_v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A51penguin_mppos_v4_pose2"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose2", "Penguin_mppos_pose2_v4 ~p~ NEW", AnimationOptions =
   {
       Prop = "prop_cs_ciggy_01",
       PropBone = 28422,
       PropPlacement = {0.09, 0.02, 0.0, 5.0, 109.0, 10.0},
   ...
   ["A52penguin_mppos_v4_pose3"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose3", "Penguimppos pose3 v4 ~p~ NEW", AnimationOptions =
   {
   ...
   ["A53penguin_mppos_v4_pose4"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose4", "Penguimppos pose4 v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A54penguin_mppos_v4_pose5"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose5", "Penguin pose5 v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A55penguin_mppos_v4_pose6"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose6", "Penguin pose6 v4 ~p~ NEW", AnimationOptions =
   {
       Prop = "ruler",
       PropBone = 12844,
   ...
   ["A56penguin_mppos_v4_pose7"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose7", "Penguimppos pose7 v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A57penguin_mppos_v4_pose8"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_pose8", "Penguin pose8 v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["A58penguin_mppos_v4_duo1_f"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_duo1_f", "penguin duo1 f v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["A59penguin_mppos_v4_duo1_m"] = {"penguin_mppos@custom@v4", "penguin_mppos_v4_duo1_m", "penguin duo1 m v4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
  ...
  ["A60penguin_mppos_pose1_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose1_v5", "penguin_mppos_pose1_v5", AnimationOptions =
  {
      Prop = "flower_neck",  
      PropBone = 24818,
  ...
  ["A61penguin_mppos_pose2_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose2_v5", "penguin_mppos_pose2_v5", AnimationOptions =
  {
      EmoteLoop = true,
      EmoteMoving = false,
  }},
  ["A62penguin_mppos_pose3_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose3_v5", "penguin_mppos_pose3_v5", AnimationOptions =
  {
      Prop = "find",  
      PropBone = 60309,
  ...
  ["A63penguin_mppos_pose4_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose4_v5", "penguin_mppos_pose4_v5", AnimationOptions =
  {
      Prop = "red_card",  
      PropBone = 28422,
  ...
  ["A64penguin_mppos_pose5_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose5_v5", "penguin_mppos_pose5_v5", AnimationOptions =
  {
      Prop = "yellow_card",  
      PropBone = 28422,
      PropPlacement = {0.11, 0.07, -0.05, -23.0, -61.0, 131.0},
  ...
  ["A65penguin_mppos_pose6_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose6_v5", "penguin_mppos_pose6_v5", AnimationOptions =
  {
      Prop = "watertank",  
      PropBone = 60309,
  ...
  ["A66penguin_mppos_pose7_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose7_v5", "penguin_mppos_pose7_v5", AnimationOptions =
  {
      Prop = "penguin_flag2",  
      PropBone = 28422,
  ...
  ["A67penguin_mppos_pose8_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose8_v5", "penguin_mppos_pose8_v5", AnimationOptions =
  {
      Prop = "logo_label",  
      PropBone = 28422,
  ...
  ["A68penguin_mppos_pose9_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose9_v5", "penguin_mppos_pose9_v5", AnimationOptions =
  {
      EmoteLoop = true,
      EmoteMoving = false,
  }},
  ["A69penguin_mppos_pose10_v5"] = {"penguin_mppos@custom@v5", "penguin_mppos_pose10_v5", "penguin_mppos_pose10_v5", AnimationOptions =
  {
      EmoteLoop = true,
      EmoteMoving = true,
  }},
   ...
   ["Nekopiggy"] = {"fos_ep_1_p1-9", "csb_imran_dual-9", "HT piggy", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew"] = {"fos_ep_1_p0-0", "cs_lazlow_dual-0", "HT new", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew2"] = {"fos_ep_1_p1-0", "cs_lazlow_dual-0", "HT new2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew3"] = {"fos_ep_1_p1-0", "csb_imran_dual-0", "HT new3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew4"] = {"fos_ep_1_p1-1", "cs_lazlow_dual-1", "HT new4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},

   ["Nekonew5"] = {"fos_ep_1_p1-1", "csb_anita_dual-1", "HT new5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew6"] = {"fos_ep_1_p1-1", "csb_imran_dual-1", "HT new6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},

   ["Nekonew7"] = {"fos_ep_1_p5-2", "csb_william_dual-2", "HT new7", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekonew8"] = {"timetable@trevor@ig_1", "ig_1_therearejustsomemoments_patricia", "HT new8", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekonew9"] = {"impexp_int_l1-11", "mp_m_waremech_01_dual-11", "HT new9", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekonew10"] = {"amb@prop_human_seat_computer@male@react_shock", "forward", "HT new10", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekonew11"] = {"amb@prop_human_seat_bar@male@elbows_on_bar@idle_b", "idle_d", "HT new11", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekonew12"] = {"amb@incar@male@security@idle_a", "idle_a", "HT new12", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekopost4"] = {"mpcas_int-2", "s_m_y_casino_01^1_dual-2", "HT post4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekohelp"] = {"missheist_agency3aig_19", "ground_call_help", "HT help", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep3"] = {"missheist_agency3amcs_4b", "crew_dead_crew2", "HT sleep3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep4"] = {"missheist_jewel", "gassed_npc_customer1", "HT sleep4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep5"] = {"missheist_jewel", "gassed_npc_customer2", "HT sleep5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep6"] = {"missheist_jewel", "gassed_npc_customer3", "HT sleep6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep7"] = {"missheist_jewel", "gassed_npc_customer4", "HT sleep7", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekositpost8"] = {"missheistdockssetup1ig_10@base", "talk_pipe_base_worker1", "HT sitpost8", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekocall"] = {"missheistdockssetup1ig_14", "floyd_ok_now_grab_the_container", "HT Call", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekodrunk4"] = {"missheistpaletopinned", "pinned_against_wall_pro_loop_buddy", "HT drunk4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekoyoga6"] = {"misslamar1leadinout", "yoga_02_idle_b", "HT yoga6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekolieabout"] = {"missmic2ig_11", "mic_2_ig_11_a_p_one", "HT lie about", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekobundle"] = {"missprologueig_2", "idle_on_floor_gaurd", "HT bundle", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekobundle2"] = {"missprologueig_2", "idle_outside_cuboard_gaurd", "HT bundle2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekosleep8"] = {"missprologueig_6", "lying_dead_brad", "HT sleep8", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekosleep9"] = {"missprologueig_6", "lying_dead_player0", "HT sleep9", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekorod"] = {"misstrevor1ig_3", "action_b", "HT rod", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekocheck2"] = {"misstrevor3", "bike_chat_b_loop_1", "HT check2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekocheck3"] = {"misstvrram_5", "marines_idle_b", "HT check3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekonumb"] = {"mp_arrest_paired", "crook_p1_idle", "HT numb", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["Nekonumb2"] = {"mp_cop_miss", "dazed", "HT numb2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["ANekosawatdee"] = {"fam_4_int_alt1-17", "cs_amandatownley_dual-17", "HT sawatdee", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = true,
   }},
   ["ANekosawatdee2"] = {"fos_ep_1_p1-26", "csb_imran_dual-26", "HT sawatdee2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["Nekosex"] = {"misscarsteal2pimpsex", "pimpsex_hooker", "HT Sex", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekosex2"] = {"misscarsteal2pimpsex", "pimpsex_pimp", "HT Sex2", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekosex3"] = {"misscarsteal2pimpsex", "pimpsex_punter", "HT Sex3", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekosex4"] = {"misscarsteal2pimpsex", "shagloop_hooker", "HT Sex4", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekosex5"] = {"misscarsteal2pimpsex", "shagloop_pimp", "HT Sex5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekosex6"] = {"rcmpaparazzo_2", "shag_action_poppy", "HT Sex6", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekosex7"] = {"rcmpaparazzo_2", "shag_action_a", "HT Sex5", AnimationOptions =
   {
       EmoteLoop = false,
       EmoteMoving = false,
    
   }},
   ["Nekogivebirth"] = {"mini@cpr@char_a@cpr_str", "cpr_kol", "HT Give birth", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekotiedup"] = {"random@burial", "b_burial", "HT Tied up", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekositchair7"] = {"anim@amb@nightclub@smoking@", "blunt_idle_a", "HT Sit Chair 7", AnimationOptions =
   {    
       Prop = 'p_cs_joint_02',
       PropBone = 28422,
   ...
   ["Nekositchair8"] = {"anim@amb@nightclub@smoking@", "blunt_idle_b", "HT Sit Chair 8", AnimationOptions =
   {    
       Prop = 'p_cs_joint_02',
       PropBone = 28422,
       PropPlacement = {0.0800003, -0.004999998, -0.035, 175.5002, 311.0003, 232.0},
   ...
   ["Nekodrink2"] = {"friends@frl@ig_1", "drink_lamar", "HT Drink 2", AnimationOptions =
   {    
   ...
   ["Nekomc"] = {"anim@amb@nightclub@lazlow@ig1_vip@", "clubvip_dlg_tonymctony_laz", "HT MC", AnimationOptions =
   {    
   ...
   ["Nekojump1"] = {"anim@arena@celeb@flat@solo@no_props@", "jump_d_player_a", "HT Jump 1", AnimationOptions =
   {    
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekojump2"] = {"anim@arena@celeb@flat@solo@no_props@", "jump_c_player_a", "HT Jump 2", AnimationOptions =
   {    
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekojump3"] = {"anim@arena@celeb@flat@solo@no_props@", "jump_b_player_a", "HT Jump 3", AnimationOptions =
   {    
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekojump4"] = {"anim@arena@celeb@flat@solo@no_props@", "jump_a_player_a", "HT Jump 4", AnimationOptions =
   {    
       EmoteLoop = false,
       EmoteMoving = false,
   ...
   ["Nekoleanbar5"] = {"switch@michael@pier", "pier_lean_smoke_idle", "HT Lean Bar 5", AnimationOptions =
   {   
       Prop = 'prop_cs_ciggy_01',
       PropBone = 58867,
   ...
   ["Nekoleanbar6"] = {"switch@michael@pier", "pier_lean_smoke_idle", "HT Lean Bar 6", AnimationOptions =
   {   
       Prop = 'p_cs_joint_02',
       PropBone = 58867,
       PropPlacement = {0.0599999, 0.005, -0.015, 40.29999, 78.3, 124.1},
   ...
   ["Nekoleanbar7"] = {"switch@michael@pier", "pier_lean_smoke_idle", "HT Lean Bar 7", AnimationOptions =
   {   
       Prop = 'prop_cigar_03',
       PropBone = 58867,
   ...
   ["Nekositmafia"] = {"safe@michael@ig_3", "cigar_idle_b_michael", "HT Sit Mafia", AnimationOptions =
   {   
       Prop = 'prop_cigar_03',
       PropBone = 58867,
   ...
   ["Nekosmell2"] = {"safe@trevor@ig_8", "ig_8_huff_gas_player", "HT Smell 2", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekofear"] = {"anim@heists@ornate_bank@hostages@cashier_b@", "flinch_loop_underfire", "HT Fear", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekowipe"] = {"switch@franklin@cleaning_car", "001946_01_gc_fras_v2_ig_5_base", "HT Wipe", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekositchair9"] = {"mini@strip_club@wade@", "leadin_loop_idle_a_stripper_a", "HT Sit Chair 9", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekositmafia2"] = {"mini@strip_club@wade@", "leadin_loop_idle_a_wade", "HT Sit Mafia 2", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekocheer2"] = {"mini@triathlon", "male_one_handed_a", "HT Cheer 2", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekocheer3"] = {"mini@triathlon", "male_two_handed_a", "HT Cheer 3", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekolean6"] = {"missarmenian1leadinoutarm_1_ig_14_leadinout", "leadin_loop", "HT Lean 6", AnimationOptions =
   {   
       --Prop = 'prop_cigar_03',
       --PropBone = 13700,
       --PropPlacement = {0.03999992, 0.03, 0.015, 0.0, 78.3002, 180},
   ...
   ["Nekodrunk"] = {"missbigscore1leadinoutbs_1_int", "leadin_loop_c_trevor", "HT Drunk", AnimationOptions =
   {   
       Prop = 'prop_wine_rose',
       PropBone = 58867,
   ...
   ["Nekopee2"] = {"missbigscore1switch_trevor_piss", "piss_loop", "HT Pee 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekolean7"] = {"misscarsteal1car_1_ext_leadin", "base_driver1", "HT Lean 7", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekopee3"] = {"misscarsteal2peeing", "peeing_loop", "HT Pee 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekoleanbar8"] = {"misscarstealfinalecar_5_ig_1", "waitloop_lamar", "HT Lean Bar 8", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekodapap"] = {"misscarstealfinalecar_5_ig_3", "leanleft_loop", "HT Dapap", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekocool"] = {"misschinese1leadinoutchi_1_mcs_4", "chi_1_mcs_4_tao_idle_2", "HT Cool", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekolean8"] = {"missclothing", "idle_a", "HT Lean 8", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekolean9"] = {"missclothing", "idle_b", "HT Lean 9", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekolean10"] = {"missclothing", "idle_c", "HT Lean 10", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekosadly"] = {"missfam4leadinoutmcs2", "tracy_loop", "HT Sadly", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoyoga2"] = {"missfam5_yoga", "c5_pose", "HT Yoga 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoyoga3"] = {"missfam5_yoga", "c6_pose", "HT Yoga 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoyoga4"] = {"missfam5_yoga", "c7_pose", "HT Yoga 4", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekopost"] = {"missfbi4leadinoutfbi_4_int", "agents_idle_a_andreas", "HT post", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomonkey"] = {"missfbi5ig_30monkeys", "monkey_a_freakout_loop", "HT Monkey", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomonkey2"] = {"missfbi5ig_30monkeys", "monkey_c_freakout_loop", "HT Monkey 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekocry"] = {"missfinale_a_ig_2", "trevor_death_reaction_pt", "HT Cry", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoreverence"] = {"missfra2", "lamar_base_idle", "HT Reverence", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekopost2"] = {"misshair_shop@barbers", "keeper_base", "HT Post 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekopost3"] = {"misshair_shop@hair_dressers", "keeper_idle_a", "HT Post 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoclamber"] = {"missheist_agency3aig_19", "ground_call_help", "HT Clamber", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekosleep2"] = {"missheist_jewel", "cop_on_floor", "HT Sleep 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoyoga5"] = {"misslamar1leadinout", "yoga_01_idle", "HT Yoga 5", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositchair10"] = {"misslester1aig_3main", "air_guitar_01_b", "HT Sit Chair 10", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositchair11"] = {"misslester1aig_5intro", "boardroom_intro_f_b", "HT Sit Chair 11", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositchair12"] = {"misslester1aig_5intro", "boardroom_intro_f_c", "HT Sit Chair 12", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekodig"] = {"missmic1leadinoutmic_1_mcs_2", "_leadin_trevor", "HT Dig", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekowashface"] = {"missmic2_washing_face", "michael_washing_face", "HT Wash Face", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekorepent"] = {"misstrevor1", "threaten_ortega_endloop_ort", "HT Repent", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositchair13"] = {"misstrevor3", "bike_chat_a_1", "HT Sit Chair 13", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekocheck"] = {"misstvrram_5", "marines_idle_b", "HT Check", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekowash"] = {"timetable@floyd@clean_kitchen@idle_a", "idle_a", "HT Wash", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekowash2"] = {"timetable@floyd@clean_kitchen@base", "base", "HT Wash 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekositpost"] = {"switch@michael@smoking2", "loop", "HT Sit Post", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost2"] = {"switch@trevor@pushes_bodybuilder", "001426_03_trvs_5_pushes_bodybuilder_idle_bb2", "HT Sit Post 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost3"] = {"timetable@reunited@ig_10", "base_jimmy", "HT Sit Post 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost4"] = {"anim@heists@fleeca_bank@hostages@intro", "intro_loop_ped_a", "HT Sit Post 4", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost5"] = {"anim@amb@office@pa@male@", "greetng_b_intro", "HT Sit Post 5", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositmafia3"] = {"anim@amb@office@boss@female@", "idle_d", "HT Sit Mafia 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost6"] = {"timetable@ron@ig_3_p3", "ig_3_p3_base", "HT Sit Post 6", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekositpost7"] = {"timetable@trevor@smoking_meth@idle_a", "idle_a", "HT Sit Post 7", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekodrunk2"] = {"timetable@tracy@ig_7@base", "base", "HT Drunk 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoverydrunk"] = {"timetable@tracy@ig_7@idle_a", "idle_a", "HT Very Drunk", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekodrunk3"] = {"timetable@tracy@ig_7@idle_a", "idle_b", "HT Drunk 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoparody"] = {"anim@mp_player_intupperthumb_on_ears", "idle_a", "HT Parody", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekoparody2"] = {"anim@mp_player_intincarthumb_on_earsstd@ps@", "idle_a", "HT Parody 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekoparody3"] = {"anim@mp_player_intincarfreakoutstd@rps@", "idle_a", "HT Parody 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekoparody4"] = {"anim@mp_player_intcelebrationmale@thumb_on_ears", "thumb_on_ears", "HT Parody 4", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekoparody5"] = {"anim@mp_player_intcelebrationfemale@thumb_on_ears", "thumb_on_ears", "HT Parody 5", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekoshow"] = {"missfbi_s4mop", "lobby_security_fp_player", "HT Show", AnimationOptions =
   {   
       EmoteLoop = false,
       EmoteMoving = true,
    
   }},
   ["Nekopicksnot"] = {"anim@mp_player_intincarnose_pickstd@ps@", "exit", "HT Pick snot", AnimationOptions =
   {   
       EmoteLoop = false,
       EmoteMoving = true,
    
   }},
   ["Nekoparody6"] = {"anim@mp_player_intincardockbodhi@rds@", "idle_a_fp", "HT Parody 6", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekofear2"] = {"anim@heists@prison_heistunfinished_biz@popov_react", "popov_flinch_a", "HT Fear 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekofear3"] = {"anim@heists@prison_heistunfinished_biz@popov_react", "popov_flinch_b", "HT Fear 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoheartbroken"] = {"anim@heists@prison_heistig_5_p1_rashkovsky_idle", "idle", "HT Heart Broken", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekofear4"] = {"anim@heists@ornate_bank@hostages@hit", "hit_loop_ped_c", "HT Fear 4", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekofear5"] = {"anim@heists@ornate_bank@hostages@hit", "hit_loop_ped_d", "HT Fear 5", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekoincite"] = {"fos_ep_1_p5-1", "csb_anita_dual-1", "HT Incite", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = true,
    
   }},
   ["Nekomasturbate"] = {"switch@trevor@jerking_off", "trev_jerking_off_exit", "HT Masturbate", AnimationOptions =
   {   
       EmoteLoop = false,
       EmoteMoving = false,
    
   }},
   ["Nekomasturbate2"] = {"switch@trevor@jerking_off", "trev_jerking_off_loop", "HT Masturbate 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekotest87"] = {"switch@trevor@puking_into_fountain", "trev_fountain_puke_loop", "HT test87", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekotest88"] = {"timetable@trevor@skull_loving_bear", "skull_loving_bear", "HT test88", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekotest89"] = {"anim@move_hostages@male", "male_idle_to_cower", "HT test89", AnimationOptions =
   {   
       EmoteLoop = false,
       EmoteMoving = false,
    
   }},
   ["Nekositmassage"] = {"missheistdocks2aleadinoutlsdh_2a_int", "massage_loop_2_floyd", "HT Sit Massage", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomassage"] = {"missheistdocks2aleadinoutlsdh_2a_int", "massage_loop_2_trevor", "HT Massage", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomassage2"] = {"missheistdocks2aleadinoutlsdh_2a_int", "massage_loop_floyd", "HT Massage 2", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomassage3"] = {"missheistdocks2bleadinoutlsdh_2b_int", "leg_massage_b_floyd", "HT Massage 3", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
    
   }},
   ["Nekomassage4"] = {"missheistdocks2bleadinoutlsdh_2b_int", "leg_massage_floyd", "HT Massage 4", AnimationOptions =
   {   
       EmoteLoop = true,
       EmoteMoving = false,
   ...
   ["Nekofoldarms2"] = {"anim@amb@nightclub@peds@", "rcmme_amanda1_stand_loop_cop", "HT Fold Arms 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["Nekocrossarms6"] = {"random@shop_gunstore", "_idle", "HT Crossarms 6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
